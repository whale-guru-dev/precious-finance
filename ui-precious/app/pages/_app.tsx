...
import { Chain, BlockchainProvider } from "@integrations-lib/core";
import { SUPPORTED_NETWORKS } from "@/defi/config";
...
export default function MyApp(props: MyAppProps) {
  ...
  return (
    <CacheProvider value={emotionCache}>
      ...
      <BlockchainProvider supportedChains={supportedChains}>
